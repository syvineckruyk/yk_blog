...
Gem::Specification.new do |s|
  ...
  s.files = ["lib/friendly_id/active_record.rb", "lib/friendly_id/active_record_adapter/configuration.rb", "lib/friendly_id/active_record_adapter/finders.rb", "lib/friendly_id/active_record_adapter/simple_model.rb", "lib/friendly_id/active_record_adapter/slug.rb", "lib/friendly_id/active_record_adapter/slugged_model.rb", "lib/friendly_id/active_record_adapter/tasks.rb", "lib/friendly_id/configuration.rb", "lib/friendly_id/finders.rb", "lib/friendly_id/railtie.rb", "lib/friendly_id/sequel.rb", "lib/friendly_id/slug_string.rb", "lib/friendly_id/slugged.rb", "lib/friendly_id/status.rb", "lib/friendly_id/test.rb", "lib/friendly_id/version.rb", "lib/friendly_id.rb", "lib/generators/friendly_id_generator.rb", "lib/tasks/friendly_id.rake", "Changelog.md", "Contributors.md", "Guide.md", "README.md", "LICENSE", "Rakefile", "rails/init.rb", "generators/friendly_id/friendly_id_generator.rb", "generators/friendly_id/templates/create_slugs.rb", "test/active_record_adapter/ar_test_helper.rb", "test/active_record_adapter/basic_slugged_model_test.rb", "test/active_record_adapter/cached_slug_test.rb", "test/active_record_adapter/core.rb", "test/active_record_adapter/custom_normalizer_test.rb", "test/active_record_adapter/custom_table_name_test.rb", "test/active_record_adapter/optimistic_locking_test.rb", "test/active_record_adapter/scoped_model_test.rb", "test/active_record_adapter/simple_test.rb", "test/active_record_adapter/slug_test.rb", "test/active_record_adapter/slugged.rb", "test/active_record_adapter/slugged_status_test.rb", "test/active_record_adapter/sti_test.rb", "test/active_record_adapter/support/database.jdbcsqlite3.yml", "test/active_record_adapter/support/database.mysql.yml", "test/active_record_adapter/support/database.postgres.yml", "test/active_record_adapter/support/database.sqlite3.yml", "test/active_record_adapter/support/models.rb", "test/active_record_adapter/tasks_test.rb", "test/friendly_id_test.rb", "test/slug_string_test.rb", "test/test_helper.rb", "extras/bench.rb", "extras/extras.rb", "extras/prof.rb", "extras/README.txt", "extras/template-gem.rb", "extras/template-plugin.rb"]
